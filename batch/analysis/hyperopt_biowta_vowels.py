...
# %% [markdown]
# # Look at hyperoptimization results for BioWTA on vowel data
...
start_seed = 800
n_seeds = 40
batch_path = os.path.join("..", "..", "batch", "biowta_vowels_ao")
...
fig, _ = make_summary_figure(
    results, log_scale=["rate", "exp_streak", "temperature", "timescale"], fct_key="fct_good", vmin=0.0, vmax=1.0, top_fraction=0.05
)
