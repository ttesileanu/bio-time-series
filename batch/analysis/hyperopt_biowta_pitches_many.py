...
# %% [markdown]
# # Look at hyperoptimization results for BioWTA on various combinations of pitches
...
start_seed = 800
n_seeds = 40
batch_path = os.path.join("..", "..", "batch", "biowta_pitches_many")

configurations = ["ce", "cg", "cb", "fa"]
