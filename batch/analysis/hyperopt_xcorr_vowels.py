...
# %% [markdown]
# # Look at hyperoptimization results for autocorrelation algorithm on vowel data
...
start_seed = 900
n_seeds = 40
batch_path = os.path.join("..", "..", "batch", "xcorr_vowels_ao")
...
fig, _ = make_summary_figure(
    results, log_scale=["rate", "exp_streak"], fct_key="fct_quantile", vmin=0.0, vmax=1.0, top_fraction=0.05
)

# %%
fig, _ = make_summary_figure(
    results, log_scale=["rate", "exp_streak"], fct_key="fct", vmin=0.0, vmax=1.0, top_fraction=0.05
)
