...
# %% [markdown]
# # Look at hyperoptimization results for BioWTA on mixed vowel data (all vowel pairs)
...
start_seed = 800
n_seeds = 40
batch_path = os.path.join("..", "..", "batch", "biowta_vowels_all")
...
fig, _ = make_summary_figure(
    results,
    log_scale=["rate", "exp_streak", "temperature", "timescale"],
    fct_key="fct_good",
    vmin=0.0,
    vmax=1.0,
    top_fraction=0.01,
)
fig.savefig(os.path.join(fig_path, "biowta_hyperopt_vowel.pdf"))
