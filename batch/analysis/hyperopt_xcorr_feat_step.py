...
# %% [markdown]
# # Look at hyperoptimization results for autocorrelation method (with `feature_step` optimization)
...
start_seed = 100
n_seeds = 40
batch_path = os.path.join("..", "..", "batch", "xcorr_ar3_feat_step")
...
fig, _ = make_summary_figure(
    results,
    log_scale=["rate", "timescale", "exp_streak", "feature_step"],
    fct_key="fct_good",
    vmin=0.0,
    vmax=1.0,
    top_fraction=0.05,
